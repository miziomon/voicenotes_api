...
app.use((req, res, next) => {
    ...
    res.header('Access-Control-Allow-Headers', 'Origin, X-Requested-With, Content-Type, Accept, accept-profile, Authorization, apikey, x-client-info, x-supabase-auth, preference, prefer, range, content-range, cache-control, pragma, expires');
